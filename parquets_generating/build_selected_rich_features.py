...
DATASET_OUTPUT = "features_dataset_selected_rich.parquet"
TEST_OUTPUT = "features_test_selected_rich.parquet"
...
def extract_selected_features_for_sample(
    ...
    # 7. response length / response ratio.
...
def main() -> None:
    ...
    device = get_device()
    print("=" * 80)
    print("BUILD SELECTED RICH FEATURES")
    print("=" * 80)

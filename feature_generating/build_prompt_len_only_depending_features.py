...
OUTPUT_DIR = Path("./artifacts/prompt_len_features")
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

TRAIN_OUTPUT = OUTPUT_DIR / "features_dataset_prompt_len_features.parquet"
TEST_OUTPUT = OUTPUT_DIR / "features_test_prompt_len_features.parquet"
...
def extract_dataset_features(df, model, tokenizer, device, has_label):
    ...
    for start in tqdm(
        ...
        desc="Extract prompt-len features",
    ):
...
def main():
    ...
    print("=" * 80)
    print("BUILD PROMPT-LEN FEATURES")
    print("=" * 80)
    print("Device:", device)
